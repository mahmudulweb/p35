...
if(isset($_POST['url']) && $_POST['url'] == '' && $_POST['message'] != ''){
	...
	$youremail = 'info@platkelvconcept.net';
...
//header('Location: https://www.platkelvconcept.net/feedback_sent.html');
//exit('Redirecting you to https://www.platkelvconcept.net/thankyou.html');
